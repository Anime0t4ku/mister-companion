    ...
    def open_explorer(self):
        ...
        try:
            ...
            if sys.platform.startswith("win"):
                ...
                subprocess.run(["mkdir", "-p", "/Volumes/MiSTer"], capture_output=True)
                subprocess.run(["mount_smbfs", f"//guest@{ip}/", "/Volumes/MiSTer"], capture_output=True)
                subprocess.Popen(["open", "/Volumes/MiSTer"])
    ...
    def open_wallpaper_folder(self):
        ...
        try:
            ...
            # macOS
                ...
                subprocess.run(["mkdir", "-p", "/Volumes/MiSTer"], capture_output=True)
                subprocess.run(["mount_smbfs", f"//guest@{ip}/", "/Volumes/MiSTer"], capture_output=True)
                subprocess.Popen(["open", "/Volumes/MiSTer/sdcard/wallpapers"])
    ...
    def open_scripts_folder(self):
        ...
        try:
            ...
            # macOS
                ...
                subprocess.run(["mkdir", "-p", "/Volumes/MiSTer"], capture_output=True)
                subprocess.run(["mount_smbfs", f"//guest@{ip}/", "/Volumes/MiSTer"], capture_output=True)
                subprocess.Popen(["open", "/Volumes/MiSTer/sdcard/Scripts"])
