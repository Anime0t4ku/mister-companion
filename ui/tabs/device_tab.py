...
class DeviceTab(QWidget):
    ...
    def build_ui(self):
        ...
        self.smb_status_label = QLabel("Remote Access: Unknown")
        ...
        self.enable_smb_button = QPushButton("Enable Access")
        self.disable_smb_button = QPushButton("Disable Access")
    ...
    def apply_disconnected_state(self):
        ...
        self.smb_status_label.setText("Remote Access: Unknown")
    ...
    def refresh_smb_status(self):
        ...
        if smb_enabled:
            self.smb_status_label.setText("Remote Access: Enabled ✓")
            self.smb_status_label.setStyleSheet("color: #00aa00;")
            self.enable_smb_button.setEnabled(False)
            self.disable_smb_button.setEnabled(True)
        else:
            self.smb_status_label.setText("Remote Access: Disabled")
